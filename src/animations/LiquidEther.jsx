  ...
  useEffect(() => {
    ...
    class CommonClass {
      ...
      init(container) {
        ...
        this.resize();
        // alpha true so background remains transparent
        this.renderer = new THREE.WebGLRenderer({ antialias: true, alpha: true });
        this.renderer.autoClear = false;
        this.renderer.setClearColor(new THREE.Color(0x000000), 0);
        this.renderer.setPixelRatio(this.pixelRatio);
        this.renderer.setSize(this.width, this.height);
        // ensure canvas covers container and is absolutely positioned for correct stacking
        ...
        // allow pointer events on the canvas so mouse interactions work
...
`;
    ...
    class WebGLManager {
      ...
      init() {
        // place renderer canvas at top of wrapper (canvas already absolute positioned)
        this.props.$wrapper.prepend(Common.renderer.domElement);
        // ensure canvas is interactive and above the background layer
        Common.renderer.domElement.style.pointerEvents = 'auto';
        Common.renderer.domElement.style.zIndex = '1';
    ...
    // ensure wrapper is positioned so absolute canvas can align
  ...
  // Return wrapper DIV — IMPORTANT: no pointer-events-none so canvas receives pointer events.
  return (
    <div
      ref={mountRef}
